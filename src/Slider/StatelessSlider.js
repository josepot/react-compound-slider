...
class StatelessSlider extends Component {
  constructor(props) {
    super(props)
  ...
  componentWillMount() {
    const { domain, step, reversed, values } = this.props
